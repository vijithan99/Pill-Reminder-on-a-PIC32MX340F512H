...
// SPI functions: http://pic32-examples.googlecode.com/svn/trunk/tedious/library/panchul/spi.c
// SPI functions: http://pic32-examples.googlecode.com/svn/trunk/tedious/library/panchul/spi.h
...
OledHostInit()
	{
    // SPI doc: http://ww1.microchip.com/downloads/en/DeviceDoc/61106G.pdf
    // FSCK = F_PB / (2*(SPIxBRG+1))
    //
//	#if defined (_BOARD_UNO_) || defined(_BOARD_UC32_)
		/* Initialize SPI port 2.
		*/
		SPI2CON = 0;
		SPI2BRG = 4;				//8Mhz, with 80Mhz PB clock; FSCK=80MHZ/(2*(4+1))
